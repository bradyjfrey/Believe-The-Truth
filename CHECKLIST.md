...
- [~] **Build the Effects** — pipeline DONE, individual effects ongoing:
  ...
  - [ ] **Healing Pulse** (`OtohimeHealingPulse`) — template designed & in `ReplicatedStorage.Effects`; needs Otohime's ability to call it + the +20 HP heal logic. *(Blocked on Otohime abilities below.)*
  - [ ] **Dark Moon** (`OtohimeDarkMoon`) — template designed & in folder; needs Otohime's ability to call it. *(Blocked on Otohime abilities below.)*
